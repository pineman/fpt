...
// AND r8
#[case(0xA0, 0xca, "b", 0xfe, 0xca, 0b0010)]
#[case(0xA0, 0xfe, "b", 0x01, 0x00, 0b1010)]
#[case(0xA1, 0xca, "c", 0xfe, 0xca, 0b0010)]
#[case(0xA2, 0xca, "d", 0xfe, 0xca, 0b0010)]
#[case(0xA3, 0xca, "e", 0xfe, 0xca, 0b0010)]
#[case(0xA4, 0xca, "h", 0xfe, 0xca, 0b0010)]
#[case(0xA5, 0xca, "l", 0xfe, 0xca, 0b0010)]
#[case(0xA7, 0xca, "a", 0xca, 0xca, 0b0010)]
// OR r8
#[case(0xB0, 0xca, "b", 0xfe, 0xfe, 0b0000)]
#[case(0xB0, 0x00, "b", 0x00, 0x00, 0b1000)]
#[case(0xB1, 0xca, "c", 0xfe, 0xfe, 0b0000)]
#[case(0xB2, 0xca, "d", 0xfe, 0xfe, 0b0000)]
#[case(0xB3, 0xca, "e", 0xfe, 0xfe, 0b0000)]
#[case(0xB4, 0xca, "h", 0xfe, 0xfe, 0b0000)]
#[case(0xB5, 0xca, "l", 0xfe, 0xfe, 0b0000)]
#[case(0xB7, 0xca, "a", 0xca, 0xca, 0b0000)]
// ADC A,r8
...
// AND (HL)
#[case(0xA6, 0xca, 0x0001, 0xfe, 0xca, 0b0010)]
#[case(0xA6, 0xfe, 0xcafe, 0x01, 0x00, 0b1010)]
// OR (HL)
...
#[rstest]
// ADD A,d8
#[case(0xC6, 0xfe, 0x01, 0xff, 0b0000)]
#[case(0xC6, 0x0f, 0x01, 0x10, 0b0010)]
#[case(0xC6, 0xff, 0x01, 0x00, 0b1011)]
// XOR d8
#[case(0xEE, 0xca, 0xfe, 0x34, 0b0000)]
#[case(0xEE, 0xca, 0xca, 0x00, 0b1000)]
// AND d8
#[case(0xE6, 0xca, 0xfe, 0xca, 0b0010)]
#[case(0xE6, 0xfe, 0x01, 0x00, 0b1010)]
// OR d8
#[case(0xF6, 0xca, 0xfe, 0xfe, 0b0000)]
#[case(0xF6, 0x00, 0x00, 0x00, 0b1000)]
